...
export function Settings() {
  ...
  const menuSections: MenuSection[] = [
    {
      title: user?.companyName || user?.name || 'Entreprise',
      subtitle: user?.email || '',
      items: [
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6">
                      <div className="relative mb-4">
                        <div className="w-24 h-24 rounded-full bg-blue-100 dark:bg-blue-500/20 flex items-center justify-center text-white font-bold text-2xl lg:text-3xl overflow-hidden">
                          {profileData.avatar ? (
                        ...
                        <label className="absolute bottom-1 right-1 w-7 h-7 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors border-2 border-[var(--bg-secondary)] cursor-pointer">
                          {uploadingAvatar ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="w-full bg-[var(--input-bg)] border border-[var(--border-color)] rounded-xl px-4 py-3 text-[var(--text-primary)] resize-none placeholder:text-[var(--text-secondary)]"
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between py-3">
                        <div>
                          <p className="font-semibold text-[var(--text-primary)]">Mode sombre</p>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4">
                        <h3 className="font-semibold text-[var(--text-primary)] mb-2">Comment créer une demande ?</h3>
                        <p className="text-sm text-[var(--text-secondary)]">
                          Rendez-vous dans "Nouvelle demande", remplissez les informations et publiez.
                        </p>
                      </div>
                      
                      <div className="bg-slate-50 dark:bg-slate-700/50 rounded-xl p-4">
                        <h3 className="font-semibold text-[var(--text-primary)] mb-2">Comment fonctionnent les devis ?</h3>
                        <p className="text-sm text-[var(--text-secondary)]">
                          Les chauffeurs reçoivent votre demande et proposent leurs prix. Vous choisissez la meilleure offre.
                        </p>
                      </div>
                    </div>
                  </motion.div>
        ...
        {showDeleteConfirm && (
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-center text-[var(--text-primary)] mb-2">Désactiver le compte ?</h3>
              ...
              <div className="flex gap-3">
                <Button
                  variant="outline"
                  onClick={() => setShowDeleteConfirm(false)}
                  className="flex-1 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-white"
                >
                  Annuler
                </Button>
                <Button
